...
from peeldb.models import (User, TwitterFollower, TwitterFriend,
                           GoogleFirend, FacebookFriend, FacebookPage,
                           FacebookGroup, Facebook, Twitter, FacebookPost, TwitterPost)
...
def add_facebook_friends_pages_groups(accesstoken, fid, user):
    ...
    for page in pages:
        url = "https://graph.facebook.com/oauth/access_token?client_id=" + settings.FB_APP_ID + \
