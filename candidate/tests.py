...
#                                       'dob': '2015-07-24', 'marital_status': 'Single'})
...
#                                          'nationality': 'indian', 'address': 'hyd',
...
#         form = TechnicalSkillForm(data={'skill': self.skill.id, 'year': 2015, 'month': 12, 'last_used': '12/12/2015', 'version': '1.1', 'proficiency': 'Good'})
#         self.assertTrue(form.is_valid())
