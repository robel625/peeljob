$('.view_comment').click(function(){var cmt_bloc=$(this).closest(".comment_section").siblings(".replies_block");$(this).closest(".comment_section").siblings(".cmments_repls").not(cmt_bloc).slideUp();if(cmt_bloc.is(':visible')){cmt_bloc.slideUp();}
